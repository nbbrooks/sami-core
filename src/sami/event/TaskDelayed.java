...
/**
 * Used to indicate that the task a proxy was executing has been moved down the
 * proxy's task ordering
 *
 * @author nbb
 */
public class TaskDelayed extends InputEvent {
    ...
    public TaskDelayed(UUID missionUuid, Task task) {
