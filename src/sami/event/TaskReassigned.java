...
/**
 * Used to indicate that a proxy is now responsible for this task, now that is has been reassigned from a different proxy
 * 
 * @author nbb
 */
public class TaskReassigned extends InputEvent {
    ...
    public TaskReassigned() {
        id = UUID.randomUUID();
    }

    public TaskReassigned(UUID missionUuid, Task task) {
